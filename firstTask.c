...
// ћаксимальное количество итераций дл€ проверки ограниченности
#define MAX_ITERATIONS 1000

// √раницы области на комплексной плоскости
#define MIN_X -2.0
#define MAX_X 1.0
#define MIN_Y -1.5
#define MAX_Y 1.5
...
char mandelbrotContains(double real, double img) {
    ...
    // ÷икл: zn+1 = zn^2 + c
    // ”словие выхода: |z|^2 >= 4 (то есть |z| >= 2) или превышен лимит итераций
    ...
    // ≈сли цикл дошел до MAX_ITERATIONS, считаем, что точка принадлежит множеству
    return 1;
}
